					...
					<div class="portlet light bordered ">
						<div class="portlet-title">
							<div class="caption font-green-haze">
								...
								<span class="caption-subject bold uppercase"> List DKP Draf</span>
							</div>
							<div class="actions">
...
var $table='';
	...
	$('#dkp_draf').parent().addClass('active');
	//dataTables
		var url='<?php echo site_url().'/engineering/get_dkp_draf'?>';
