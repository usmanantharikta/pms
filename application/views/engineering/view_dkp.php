...
$(document).ready(function(){
  ...
  //hidden
  $(".portlet-body table-responsive .btn ").addClass('hide');
	...
	$("#dkp-form").submit(function(event)
     {
      ...
      $('.help-block').empty(); // clear error string
           $.ajax({
               ...
               {
  						 		Metronic.stopPageLoading();
									$('.dkp-isian').removeClass('hide'); //show material etc
									$('[name="id_dkp"]').val(data.dkp_id); //assigment id dkp master for other table such as material man power etc
									// id_dkp=data.dkp_id;
									initial_table(data.dkp_id);
