					...
					<div class="portlet light bordered ">
						<div class="portlet-title">
							<div class="caption font-green-haze">
								...
								<span class="caption-subject bold uppercase"> List DKP Approved </span>
							</div>
							<div class="actions">
...
var $table='';
	...
	$('#listApproved').parent().addClass('active');
	//dataTables
		var url='<?php echo site_url().'/engineering/get_dkp_approved'?>';
	...
	function reload_tab()
	{
		$('#table_dkp_approved').DataTable().ajax.reload(null, false);
	}
