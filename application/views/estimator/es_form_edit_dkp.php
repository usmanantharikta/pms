	...
	<div class="page-container">
		...
		<div class="col-md-12 dkp-isian hide">
			...
			<div class="portlet red-flamingo box full-height-content full-height-content-scrollable">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-flask"></i>(UOM) Material
					</div>
					<div class="tools">
						<a href="javascript:;" class="collapse">
						</a>
				...
				<form id="dkp_detail_form" method="post" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="form-body">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-3">Total Basic Price</label>
									<div class="col-md-9">
						...
						<div class="form-body">
							...
							<div class="row">
								...
								<div class="col-md-12 new_main hide">
									<div class="form-group">
										<label class="control-label col-md-3">New Type</label>
										<div class="col-md-9">
								...
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-3">New Group</label>
										<div class="col-md-9">
	...
	excel_upload.on("success", function(file, response) {
		...
		if(obj.status){
			bootbox.alert({
				...
				message: 'Well Done, Import Success !!!',
			});
			location.reload();
	...
	$("#dkp-form").submit(function(event)
	{
		...
		$.ajax({
			...
			success: function(data)
			{
				...
				window.location.href="<?php echo site_url().'engineering/create_dkp?sppr=';?>"+$('[name="no_sppr"]').val()+'&id_dkp='+data.dkp_id;
			},
...
function add(){
	...
	if(type=='material'){ //if material
		...
		url='<?php echo site_url()."estimator/edit_material"?>'; //save
		var url1='<?php echo site_url().'engineering/get_materal/'?>'+id_dkp; //get list
		var elm='_material';
	}
...
function edit_item(id, colom, table){
	$.ajax({
		...
		success: function(data)
		{
			show_modal('edit');
			// bootbox.alert('success delete data');
			var col=['dkp_id', 'id_material', 'material_no','material_dec', 'material_name', 'qty', 'unit', 'weight', 'remarks'];
