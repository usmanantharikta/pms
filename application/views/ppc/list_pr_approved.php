					...
					<div class="portlet light bordered ">
						<div class="portlet-title">
							<div class="caption font-green-haze">
								...
								<span class="caption-subject bold uppercase"> List PR Approved </span>
							</div>
							<div class="actions">
...
var $table='';
	...
	$('#listPRApproved').parent().addClass('active');
...
$("#form-filter").submit(function(event){
	...
	$.ajax({
		url: "<?php echo site_url('ppc/get_list_pr_approved'); ?>",
		type: 'POST',
		data: formData,
		dataType: "JSON",
		async: false,
