						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-3">ID DKP</label>
									<div class="col-md-9">
										<input disabled name="id_dkp" type="text" class="form-control" value="" placeholder="">
										<span class="help-block">
										</span>
									</div>
								</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-md-9">
										<input disabled name="id_material"  type="text" class="form-control" value="" placeholder="">
										<span class="help-block">
										</span>
									</div>
								</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-md-9">
										<input disabled name="qty_budget" type="number" class="form-control" placeholder="Quantity Budget">
										<span class="help-block">
										</span>
									</div>
								</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-md-9">
										<input disabled name="basic_price_budget" type="number" class="form-control" placeholder="Basic Price Budget">
										<span class="help-block">
										</span>
									</div>
								</div>
