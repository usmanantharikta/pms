...
<head>
<meta charset="utf-8"/>
<title>List BPMB Approved</title>
					...
					<div class="portlet light bordered ">
						<div class="portlet-title">
							<div class="caption font-green-haze">
								...
								<span class="caption-subject bold uppercase"> List BPMB Approved </span>
							</div>
							<div class="actions">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
						...
						<div class="portlet-body">
							...
							<table  id="table-filter" class="table table-hover table-bordered  ">
							</table>
...
var $table='';
	...
	$('#listBPMBApproved').parent().addClass('active');
...
$("#form-filter").submit(function(event){
	...
	$.ajax({
		url: "<?php echo site_url('ppc/filter_approved'); ?>",
		type: 'POST',
		data: formData,
		dataType: "JSON",
		async: false,
