					...
					<div class="portlet light bordered ">
						<div class="portlet-title">
							<div class="caption font-green-haze">
								...
								<span class="caption-subject bold uppercase">CREATE PR </span>
							</div>
							<div class="actions">
					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-offset-5 col-md-6">
								<button id="submit-first" onclick="build_pr()" class="btn green">Create PR</button>
			...
			<div class="modal-body">
				<!-- <div class="scroller" style="height:300px" data-always-visible="1" data-rail-visible1="1"> -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input name="create_date" value="<?php echo date('Y-m-d');?>" type="text" disabled class="form-control datepicker" placeholder="Tanggal">
                      <span class="help-block">
                       </span>
                    </div>
                  </div>
...
function initial_table(id)
{
	...
	$('.foot-form').addClass('hide');
		//dataTables material
	var url='<?php echo site_url().'ppc/get_material_progress_pr/'?>'+id;
...
$(document).ready(function(){
	...
	Metronic.stopPageLoading();
	 ...
	 function build_pr()
	 {
		 ...
		 $.ajax({
				 url : '<?php echo site_url().'/ppc/build_pr'?>',
				 type: "POST",
