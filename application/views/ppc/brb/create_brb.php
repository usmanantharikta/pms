					...
					<div class="portlet light bordered ">
						<div class="portlet-title">
							<div class="caption font-green-haze">
								...
								<span class="caption-subject bold uppercase"> CREATE BRB </span>
							</div>
							<div class="actions">
					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-offset-5 col-md-6">
								<button id="submit-first" onclick="build_bpmb()" class="btn green">Create BRB</button>
...
function initial_table(id)
{
	...
	$('.foot-form').addClass('hide');
		//dataTables material
	var url='<?php echo site_url().'ppc_brb/get_material_by_dkp/'?>'+id;
...
$(document).ready(function(){
	...
	Metronic.stopPageLoading();
	 ...
	 function build_bpmb()
	 {
		 ...
		 $.ajax({
				 url : '<?php echo site_url().'/ppc_brb/build_brb'?>',
				 type: "POST",
	 ...
	 function save_brb()
	 {
		 ...
		 $.ajax({
				 url : '<?php echo site_url().'/ppc_brb/save_brb'?>',
				 type: "POST",
				 // data: {'id_item': id,'colom':colom, 'table': table},
				 data: formd,
				 processData: false,
